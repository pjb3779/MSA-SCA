...
@Entity
@Table(
    name = "build_run_detail",
    indexes = { @Index(name = "idx_build_detail_service_module", columnList = "service_module_id") }
)
public class BuildRunDetailEntity {
    ...
    private BuildRunDetailEntity(ToolRunEntity toolRun, ServiceModuleEntity serviceModule) {
        this.toolRun = toolRun;
        this.serviceModule = serviceModule;
    }

    public static BuildRunDetailEntity create(ToolRunEntity toolRun, ServiceModuleEntity serviceModule) {
        return new BuildRunDetailEntity(toolRun, serviceModule);
    }
}